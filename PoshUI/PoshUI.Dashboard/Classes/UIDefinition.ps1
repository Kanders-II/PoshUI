...
class UIDefinition {
    ...
    # Template/View Mode properties - hardcoded to Dashboard for this module
    [string]$ViewMode = 'Dashboard'  # Always 'Dashboard' for PoshUI.Dashboard module
    [string]$Template = 'Dashboard'  # Always 'Dashboard' for PoshUI.Dashboard module
    [int]$GridColumns = 3            # Dashboard grid columns (1-6)
